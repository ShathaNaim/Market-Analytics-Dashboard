...
urlpatterns = [
    ...
    path('insights', InsightsView.as_view(), name='insights-no-slash'),
    ...
    path('market-comparison', MarketComparisonView.as_view(), name='market-comparison-no-slash'),
    path('market-comparison/', MarketComparisonView.as_view(), name='market-comparison'),
